...
1. Opening and running the .R scripts. 
    - Open the scripts folder, and then open the main_script.R file. Make sure to change the working directory to the level of the scripts folder.
...
2. Opening and viewing a code-integrated Quarto document (works like RMarkdown).
